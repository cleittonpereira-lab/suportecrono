/**
 * Persistência simples de versões (revisões) do relatório de Compressão
 * Diametral em PDF usando IndexedDB. Escopo por ensaio (`scopeId`),
 * tipicamente o `ctx.ensaio.id`. Se não houver contexto, usa a chave "local".
 */

const DB_NAME = "suporte-infra-report-versions-compressao-diametral";
