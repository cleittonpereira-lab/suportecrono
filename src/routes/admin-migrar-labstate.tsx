...
/**
 * A antiga ferramenta de migração (_lab-state.json → tabelas, importação do
 * localStorage, usuários do Supabase, teste do Drive) saiu: já cumpriu o papel,
 * e duas das funções dela gravavam dados sem login, protegidas só por uma
 * senha escrita no código.
 */
