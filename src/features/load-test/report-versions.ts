/**
 * Persistência simples de versões (revisões) do relatório de Point Load
 * Test em PDF usando IndexedDB. Mesmo padrão de compressao-simples/report-versions.ts.
 */

import { numeroDaProximaRevisao } from "@/lib/numero-da-revisao";

const DB_NAME = "suporte-infra-report-versions-load-test";
...
/**
 * Igual a `replaceVersionPdf`, mas também deixa trocar o nome do arquivo —
 * usado por "Atualizar PDF com os dados atuais" na tela de verificação.
 */
