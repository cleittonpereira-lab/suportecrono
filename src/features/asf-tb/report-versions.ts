/**
 * Versões (revisões) em PDF do laudo de ASF.TB guardadas no navegador
 * (IndexedDB), por ensaio (`scopeId`). Mesmo padrão do ASF.DAP; as revisões
 * de outros computadores vêm do Drive (lib/revisoes-do-drive.ts).
 */

import { numeroDaProximaRevisao } from "@/lib/numero-da-revisao";

const DB_NAME = "suporte-infra-report-versions-asf-tb";
